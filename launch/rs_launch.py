...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.exposure', 'default': '156', 'description': 'manual exposure value (1/10000s units)'},
                           {'name': 'rgb_camera.white_balance', 'default': '4000.', 'description': 'manual white balance temperature (K)'},
                           {'name': 'rgb_camera.color_profile',     'default': '640,480,30', 'description': 'color stream profile'},
                           {'name': 'rgb_camera.color_format',      'default': 'RGB8', 'description': 'color stream format'},
                           {'name': 'rgb_camera.enable_auto_exposure', 'default': 'false', 'description': 'enable/disable auto exposure for color image'}, # 자동 노출 끄기
                           {'name': 'rgb_camera.enable_auto_white_balance', 'default': 'false', 'description': 'enable/disable auto white balance for color image'}, # 자동 화밸 끄기
    ...
    return [
        launch_ros.actions.Node(
            ...
            parameters=[params, params_from_file, {
                ...
                # 'rgb_camera.white_balance': 6000. # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 여기다
            }], 
            output=_output,
